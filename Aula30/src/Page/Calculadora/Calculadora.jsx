...
export default function Calculadora() {
    ...
    return (
        ...
        <>
            ...
            <div>
                <Input label="Numero 01" value={num1} onChange={(e) => setNum1(e.target.value)} placeholder="Digite um valor" />
                <Input label="Numero 02" value={num2} onChange={(e) => setNum2(e.target.value)} placeholder="Digite um valor" />
